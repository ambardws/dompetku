  ...
  <div class="bg-gray-100 dark:bg-gray-950 pb-16 transition-colors">
    <div class="w-full bg-white dark:bg-gray-900 min-h-screen px-4 py-6 sm:py-8 pb-24">
      ...
      <NuxtLink
        ...
        class="flex items-center justify-between p-4 mb-4 bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 rounded-xl border border-indigo-200 dark:border-indigo-800 transition-all duration-200 group"
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="font-semibold text-indigo-900 dark:text-indigo-100">Recurring Transactions</p>
            <p class="text-sm text-indigo-600 dark:text-indigo-400">Automated regular transactions</p>
          </div>
        </div>
